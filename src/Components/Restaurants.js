...
import mug from '../img/swiggy.gif'
...
export default function Restaurants(props) {
    ...
    const sortData = (val) => {
        ...
        if (val === 3) {
            newdata.sort(function (x, y) {
                return Number(x.cost) - Number(y.cost);
            });
        ...
        if (val === 4) {
            newdata.sort(function (x, y) {
                return Number(y.cost) - Number(x.cost);
            });
    ...
    const createComponent = (obj) => {
        ...
        return (
            ...
            <div className="col mt-5 pt-5 shadow me-3" style={{ height: "400px" }}>
                <Link
                    className="link"
                    to="/item"
                    state={{ image: obj.image, body: obj.body, rating: obj.rating, cost: obj.cost, time: obj.time, title: obj.title, area: place }}
                >
                    <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                        <img src={obj.image} className="card-img-top" alt="food" />
                        <div class="card-body">
                            <h5 className="card-title">{obj.title}</h5>
                            <p className="card-text text-muted fw-light" style={{ fontSize: "15px" }}>{obj.body}</p>
                            <div className="d-flex gap-1 text-muted" style={{ fontSize: "15px" }}>
                                <div className="rating">
                                    <span >&#9733;</span>
                                    <span>{obj.rating}</span>
                                </div>
                                <div>•</div>
                                <div>{obj.time} MINS</div>
                                <div>•</div>
                                <div>₹{obj.cost} FOR TWO</div>
                            </div>
                        </div>
                    </div>
                </Link>
    ...
    if (wait) {
        ...
        return (
            <div className="d-flex justify-content-center">
                <img src={mug} alt="loder" />
            </div>
        )
    }
    return (
        <>
            <span style={{ right: "417px", top: "16px", fontSize: "12px" }} className="position-absolute fw-bold text-white">{props.sortData.SwiggyReducer.itemData.reduce((acc, curr) => { return acc + Number(curr.counter) }, 0)}</span>
                    ...
                    <div className="col align-self-center">
                        <ul className="list-inline d-flex gap-5" >
                            ...
                            <li>
                                ...
                                <span className="ms-2">{props.sortData.SwiggyReducer.signupData.length > 0 ? props.sortData.SwiggyReducer.signupData[0].name : "Sign up"}</span>
                            </li>
                            <li>
            ...
            <>
                <div style={{ background: '#171a29', padding: '20px 10px' }}>
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div className="d-flex  justify-content-evenly">
                                        ...
                                        <div className="bg-secondary photo d-block "><img
            ...
            <>
                <div className="container mt-5">
                    <div className="row border-bottom">
                        <div className="col-4 fw-bold fs-3">12 resturants</div>
                        <div className="col">
                            <ul className="list-inline d-flex gap-5">
                                <li className="text-muted">Relevence</li>
                                <li className="text-muted" onClick={() => sortData(1)}>Delivery Time</li>
                                <li className="text-muted" onClick={() => sortData(2)}>Rating</li>
                                <li className="text-muted" onClick={() => sortData(3)}>Cost: Low To High</li>
                                <li className="text-muted me-auto" onClick={() => sortData(4)}>Cost: High To Low</li>
                                <li >Filters</li>
                ...
                <div className="container">
                    <div className="row">
                        {foodArr.map(obj => createComponent(obj))}
                    </div>
                </div>
                ...
                <div className="container mt-5">
                    <div className="row">
                        <div className="col">
                            <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                                <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/lihhat10emz0wipaev5c" className="card-img-top" alt="food" />
                                <div class="card-body">
                                    <h5 className="card-title">Dice N Dine</h5>
                                    <p className="card-text text-muted fw-light" style={{ fontSize: "15px" }}>American, Asian, Chinese, Continental, Desserts, Italian, Jain, Mexican</p>
                                    <div className="d-flex gap-1 text-muted" style={{ fontSize: "15px" }}>
                                        <div className="rating">
                                            <span >&#9733;</span>
                                            <span>4.4</span>
                        ...
                        <div className="col">
                            <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                                <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/odnumkswp7xjd79kzpmy" className="card-img-top" alt="food" />
                                <div class="card-body">
                                    <h5 className="card-title">Burger King</h5>
                                    <p className="card-text text-muted fw-light" style={{ fontSize: "15px" }}>American, Fast Food</p>
                                    <div className="d-flex gap-1 text-muted" style={{ fontSize: "15px" }}>
                                        <div className="rating">
                                            <span >&#9733;</span>
                                            <span>4.1</span>
                        ...
                        <div className="col">
                            <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                                <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/yc0asfa2j9elggstyjg4" className="card-img-top" alt="food" />
                                <div class="card-body">
                                    <h5 className="card-title">Madeena Hotel</h5>
                                    <p className="card-text text-muted fw-light" style={{ fontSize: "15px" }}>Biryani, Mughlai, Indian, Beverages</p>
                                    <div className="d-flex gap-1 text-muted" style={{ fontSize: "15px" }}>
                                        <div className="rating">
                                            <span >&#9733;</span>
                                            <span>4.0</span>
                        ...
                        <div className="col">
                            <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                                <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/mtfco4meitoh97jynjxd" className="card-img-top" alt="food" />
                                <div class="card-body">
                                    <h5 className="card-title">Leon Grill</h5>
                                    <p className="card-text text-muted fw-light" style={{ fontSize: "15px" }}>American, Arabian, Asian, Turkish, Portuguese</p>
                                    <div className="d-flex gap-1 text-muted" style={{ fontSize: "15px" }}>
                                        <div className="rating">
                                            <span >&#9733;</span>
                                            <span>4.2</span>
            ...
            <div className="container mt-5 pt-5">
                <div className="row">
                    <div className="col">
                        <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                            <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/hj0by11k5rr2ryhl81lt" className="card-img-top" alt="food" />
                            <div class="card-body">
                                <h5 className="card-title">Chicking</h5>
                                <p className="card-text text-muted fw-light" style={{ fontSize: "15px" }}>American, Asian, Chinese, Continental, Desserts, Italian, Jain, Mexican</p>
                                <div className="d-flex gap-1 text-muted" style={{ fontSize: "15px" }}>
                                    <div className="rating">
                                        <span >&#9733;</span>
                    ...
                    <div className="col">
                        <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                            <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/ycqqb0u9zx5cszgwn4bq" className="card-img-top" alt="food" />
                            <div class="card-body">
                                <h5 className="card-title">Onesta</h5>
                                <p className="card-text text-muted fw-light" style={{ fontSize: "15px" }}>American, Fast Food</p>
                                <div className="d-flex gap-1 text-muted" style={{ fontSize: "15px" }}>
                                    <div className="rating">
                                        <span >&#9733;</span>
                    ...
                    <div className="col">
                        <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                            <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/gqbbdwvrs1kzwftvbrp0" className="card-img-top" alt="food" />
                            <div class="card-body">
                                <h5 className="card-title">Sinful Dessert</h5>
                                <p className="card-text text-muted fw-light" style={{ fontSize: "15px" }}>Biryani, Mughlai, Indian, Beverages</p>
                                <div className="d-flex gap-1 text-muted" style={{ fontSize: "15px" }}>
                                    <div className="rating">
                                        <span >&#9733;</span>
                    ...
                    <div className="col">
                        <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                            <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/bnjz5aqntegphkslpg4l" className="card-img-top" alt="food" />
                            <div class="card-body">
                                <h5 className="card-title">Rotti Walla</h5>
                                <p className="card-text text-muted fw-light" style={{ fontSize: "15px" }}>American, Arabian, Asian, Turkish, Portuguese</p>
                                <div className="d-flex gap-1 text-muted" style={{ fontSize: "15px" }}>
                                    <div className="rating">
                                        <span >&#9733;</span>
            ...
            <div className="container mt-5 pt-5">
                <div className="row">
                    <div className="col">
                        <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                            <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/zy1rqff7pmqwsbucltd7" className="card-img-top" alt="food" />
                            <div class="card-body">
                                <h5 className="card-title">Briyani Trip</h5>
                                <p className="card-text text-muted fw-light" style={{ fontSize: "15px" }}>American, Asian, Chinese, Continental, Desserts, Italian, Jain, Mexican</p>
                                <div className="d-flex gap-1 text-muted" style={{ fontSize: "15px" }}>
                                    <div className="rating">
                                        <span >&#9733;</span>
                    ...
                    <div className="col">
                        <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                            <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/ahvxah9qdtouklavjyaq" className="card-img-top" alt="food" />
                            <div class="card-body">
                                <h5 className="card-title">Fresh Bites</h5>
                                <p className="card-text text-muted fw-light" style={{ fontSize: "15px" }}>American, Fast Food</p>
                                <div className="d-flex gap-1 text-muted" style={{ fontSize: "15px" }}>
                                    <div className="rating">
                                        <span >&#9733;</span>
                    ...
                    <div className="col">
                        <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                            <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/yyeotyfezh8sig4hfrkk" className="card-img-top" alt="food" />
                            <div class="card-body">
                    ...
                    <div className="col">
                        <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                            <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/rxzhywfw8ishbnqdgpfu" className="card-img-top" alt="food" />
                            <div class="card-body">
            ...
            <div className="container mt-5 pt-5">
                <div className="row">
                    <div className="col">
                        <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                            <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/q0bqqz9lpedssula6lsb" className="card-img-top" alt="food" />
                            <div class="card-body">
                    ...
                    <div className="col">
                        <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                            <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/teg1rujhfwroaoig95qs" className="card-img-top" alt="food" />
                            <div class="card-body">
                                <h5 className="card-title">AL-BEK</h5>
                                <p className="card-text text-muted fw-light" style={{ fontSize: "15px" }}>American, Fast Food</p>
                                <div className="d-flex gap-1 text-muted" style={{ fontSize: "15px" }}>
                                    <div className="rating">
                                        <span >&#9733;</span>
                    ...
                    <div className="col">
                        <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                            <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/tnq3ltee3hc77snyndfd" className="card-img-top" alt="food" />
                            <div class="card-body">
                                <h5 className="card-title">Paratha Envy</h5>
                                <p className="card-text text-muted fw-light" style={{ fontSize: "15px" }}>Biryani, Mughlai, Indian, Beverages</p>
                                <div className="d-flex gap-1 text-muted" style={{ fontSize: "15px" }}>
                                    <div className="rating">
                                        <span >&#9733;</span>
                    ...
                    <div className="col">
                        <div className="card border-0" style={{ width: "17rem", height: "17rem" }}>
                            <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/voa82azf9tf1lhbom83c" className="card-img-top" alt="food" />
                            <div class="card-body">
                                <h5 className="card-title">7 Plates</h5>
                                <p className="card-text text-muted fw-light" style={{ fontSize: "15px" }}>American, Arabian, Asian, Turkish, Portuguese</p>
                                <div className="d-flex gap-1 text-muted" style={{ fontSize: "15px" }}>
                                    <div className="rating">
                                        <span >&#9733;</span>
